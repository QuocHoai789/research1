                        ...
                        <div class="p-b-25">
                            ...
                            <div class="flex-wr-sb-s p-t-15">
                                <div class="h3 w-100 text-center">
                                    <a class="float-right" href="{{ route('dangkydetaicapbo') }}"><span
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($level_ministry as $value)
                                            <tr>
                                                <th scope="row">{{ $i++ }}</th>
                                                ...
                                                <td class="text-center">
                                                    @if ($value->close == 0)
                                                        <a href="{{ route('theodoidetai', $value->slug_name_topic) }}"><i
                                ...
                                <div class="row">{{ $level_ministry->links() }}</div>
