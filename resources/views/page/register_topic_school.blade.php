                    ...
                    <div class="p-b-25">
                        <div class="how2 how2-cl1 flex-s-c">
                            <h3 class="f1-m-2 cl12 tab01-title">
                                <a href="{{ route('nghiencuukhoahoccaptruong') }}"> Danh mục đề tài nghiên
                                    cứu khoa học cấp trường</a> / Đăng ký đề tài
                            </h3>
                        </div>
                        ...
                        <div class="flex-wr-sb-s p-t-15">
                            ...
                            action="{{ route('dangkydetaicaptruong') }}" name="register_topic">
                                @csrf
                                <div class="row">
