                        ...
                        <div class="p-b-25">
                            <div class="how2 how2-cl1 flex-s-c">
                                <h3 class="f1-m-2 cl12 tab01-title">
                                    Gia hạn thực hiện biên soạn tài liệu giảng dạy
                                </h3>
                            </div>
                            ...
                            @endif
                            <div class="p-t-15">
                                <form enctype="multipart/form-data" class="w-100" method="post" action="{{ route('postgiahantailieubaigiang',$document->id)}}">
                                    @csrf
                                    <div class="row mt-3">
                                        <div class="col-12">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-lg-12">
                                            <label class="name-title">7. Nội dung chưa hoàn thành: </label><i> (theo hợp đồng hoặc đề cương)</i>
                                            <textarea class="form-control" name="content" id="exampleFormControlTextarea1"
                                                rows="5" placeholder="Nội dung chưa hoàn thành"
                                                required>{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-12 col-lg-12">
                                            <label class="name-title">8. Nguyên nhân</label>
                                            <textarea class="form-control" name="reason" id="exampleFormControlTextarea1"
                                                rows="5" placeholder="Nguyên nhân và lý do gia hạn" required>{{ old('reason') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="name-title" for="exampleFormControlInput1">9. Đề nghị gia hạn:</label>
