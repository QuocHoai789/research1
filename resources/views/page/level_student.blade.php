                    ...
                    <div class="p-b-25">
                        ...
                        <div class="flex-wr-sb-s p-t-15">
                            <div class="h3 w-100 text-center">
                                <a class="float-right" href="{{ route('dangkydetaisinhvien') }}"><span
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($level_student as $value)
                                        <tr>
                                            <th scope="row">{{ $i++ }}</th>
                                            ...
                                            <td class="text-center">
                                                @php
                                                       statusTopic($value->status, $value->close);
                                                   @endphp
                                            </td>
                            ...
                            <div class="row">{{ $level_student->links() }}</div>
