...
<body>
	...
	<div class="dashboard-header">
		<nav class="navbar navbar-expand-lg bg-white fixed-top">
			<a class="navbar-brand"><img class="logo-img" width="50" src="cntt/images/icons/logo.png" alt="logo"></a><span class="h7">Thẩm định nghiệm thu biên soạn tài liệu giảng dạy</span> 
                        ...
                        {{-- <div class="row p-l-20">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12 form-group">
                                <div class="form-check" style=" padding-left: 25px;">
                                  <input class="form-check-input" type="radio" name="conclude" id="ability_to_perform_1" value="1" required>
                             ...
                             <div class="col-sm-12 col-md-12 col-lg-12 form-group">
                                <div class="form-check" style=" padding-left: 25px;">
                                  <input class="form-check-input" type="radio" name="conclude" id="ability_to_perform_2" value="2" required >
