                                    ...
                                    <div class="row m-3 pl-5 pr-5">
                                        <div class="col-12 text-right">
                                            <a class="btn btn-primary col-12"
                                                href="{{ route('downloadformdecuong', $doc->id) }}" role="button">Tải
                                                xuống</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <p class="p-l-20">
                                                        @foreach ($evalute_doc as $eva)
                                                            <span class="font-weight-bold">- {{ $eva->opinion }}</span><br/>
                                                        @endforeach
                                                        
                                                        <span class="font-weight-bold">- {{ $outside_doc->opinion }}</span><br/>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="row">
