        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Cập nhật thông báo</h2>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <h5 class="card-header">Cập nhật thông báo</h5>
                ...
                @endif
                    <div>
                        <form method="post" action="{{ route('postchinhsuathongbao',$notice->id) }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <textarea style="padding-left: 10px;" class="form-control " name="title" placeholder="Tiêu đề ..."  required>{{ $notice->title }}</textarea>
                                </div>
                              </div>
                            <div class="form-group row">
                              <label for="inputEmail3" class="col-sm-2 col-form-label">Nội dung chi tiết</label>
                              <div class="col-sm-10">
                                <textarea style="padding-left: 10px;" class="form-control ckeditor " name="content" placeholder="Nội dung chi tiết..." required>{!! $notice->content !!}</textarea>
                              </div>
                            </div>
