...
<head>
    ...
    <title>Đăng nhập đánh giá biên soạn tài liệu - Phòng khoa học công nghệ - Nghiên cứu và phát triển</title>
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><img class="logo-img"  src="cntt/images/icons/favicon.png" alt="logo"><span class="splash-description"><b>Đánh giá  biên soạn tài liệu - Phòng khoa học công nghệ - Nghiên cứu và phát triển</b></span></div>
            <div class="card-body">
                @if(Session::has('flag'))
