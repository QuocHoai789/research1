                        ...
                        <div class="row">
                          <div class="col-7">
                            <p>
                              ...
                              <span class="font-weight-bold">{{ $evalute_outside->name }}</span>
                            </p>
                          </div>
                          <div class="col-5">
                            <p>
                           ...
                           <table class="table-custom">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>20</td>
                                <td class="font-weight-bold">{{ $evalute_outside->curriculum_structure }}</td>
                              </tr>
                              <tr>
                                <td>2</td>
                                <td>
                                ...
                                <td>25</td>
                                <td class="font-weight-bold">{{ $evalute_outside->suitability }}</td>
                              </tr>
                              <tr>
                                <td>3</td>
                                ...
                                <td>35</td>
                                <td class="font-weight-bold">{{ $evalute_outside->urgency }}</td>
                              </tr>
                              <tr>
                                <td>4</td>
                                ...
                                <td>20</td>
                                <td class="font-weight-bold">{{ $evalute_outside->duplication }}</td>
                              </tr>
                              <tr>
                                <td></td>
                                <td>
                                ...
                                <td>100</td>
                                <td class="font-weight-bold">{{ $evalute_outside->total }}</td>
                              </tr>
                              <tr>
                                <td colspan="3">
                               ...
                               <td class="font-weight-bold">
                                 @if($evalute_outside->classification == 1)
                                 Tốt
                                 @elseif($evalute_outside->classification == 2)
                                 Khá
                                 @elseif($evalute_outside->classification == 3)
                                 Đạt
                                 @endif
                               </td>
                             </tr>
                              ...
                              <div class="row p-t-15">
                                <div class="col-12">
                                  <p>
                                    ...
                                    <span class="font-weight-bold">{{ $evalute_outside->opinion }}</span>
                                   </p>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-12">
                                  <p>
                                    <span>Kết luận:</span>
                                    <span class="font-weight-bold">
                                      @if($evalute_outside->conclude == 1)
                                      Đồng ý thông qua đề cương (điểm đánh giá ≥ 80 điểm).
                                      @elseif($evalute_outside->conclude == 2)
                                      Biên soạn lại.
                                      @endif
                                    </span>
                                   </p>
