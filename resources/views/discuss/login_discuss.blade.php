...
<head>
    ...
    <title>Đăng nhập phản biện thuyết minh đề tài - Phòng khoa học công nghệ - Nghiên cứu và phát triển</title>
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><img class="logo-img"  src="cntt/images/icons/favicon.png" alt="logo"><span class="splash-description"><b>Phản biện thuyết minh đề tài - Phòng khoa học công nghệ - Nghiên cứu và phát triển</b></span></div>
            <div class="card-body">
                @if(Session::has('flag'))
                <div class="alert alert-{{Session::get('flag')}}">{{Session::get('message')}}</div>
                @endif
                <form action="{{route('logindiscuss')}}" method="post">
