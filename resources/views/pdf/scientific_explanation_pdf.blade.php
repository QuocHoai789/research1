    ...
    <div id="page-download">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="text-uppercase title-page pl-5">thuyết minh đề tài nghiên cứu khoa học</p>
            </div>
        </div>
        <div class="page-content font-110">
            ...
            <div class="row mt-3">
                ...
                <div class="clearb"></div>
                    ...
                    <div class="row pl-5" style="display:block">
                        <div class="col-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row pl-3">
                        <div class="col-4">11.1. Mục tiêu chung:</div>
                        <div class="col-8">
                            <p class="pl-3"><span>
                                    @isset($target->general)
                                    {{ $target->general }}
                                    @endisset
                                </span></p>
                        </div>
                    ...
                    <div class="row pl-3">
                        <div class="col-4">11.2. Mục tiêu riêng:</div>
                        <div class="col-8">
                            <p class="pl-3"><span>
                                    @isset($target->private)
                                    {{ $target->private }}
                                    @endisset
                                </span></p>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="pl-3">
                        <span>
                            @isset($scientificExplanation->product_diff)
                            {{ $scientificExplanation->product_diff }}
                            @endisset
                        </span>
                    </p>
                </div>
                    ...
                    <table class="table-custom">
                        ...
                        <tbody>
                            ...
                            <?php $stt1 = 0; ?>
                                ...
                                @endforeach
                                <tr>
                                    <td colspan="3"><span class="title-field-bold">Tổng chi phí</span>
                                    </td>
