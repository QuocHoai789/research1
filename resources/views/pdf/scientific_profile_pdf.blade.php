    ...
    <div id="page-download">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <p class="text-uppercase title-page pl-5">lý lịch khoa học</p>
            </div>
        </div>
        <div class="page-content font-110">
            <div class="row">
                ...
                <div class="col-4">
                    <p><span class="title-field-bold">2. Nam/Nữ:</span> <span class="text-capitalize">
                            @if ($data->gender == 1)
                                {{ 'nam' }}
            ...
            <div class="row">
                <div class="col-12">
                    <p style="font-family:DejaVu Sans,sans-serif;"><span class="title-field-bold"
                            style="font-family:DejaVu Sans,sans-serif;">7. Chức vụ hiện nay:</span> <span
            ...
            <div class="row mt-4">
                ...
                <div class="row pl-5">
                    ...
                    <div class="col-4">
                        <p><span class="title-field">Điện thoại:{{ $contact->phoneNumber }}</span> <span
            ...
            <div class="row mt-3">
                ...
                <div class="row pl-5">
                    <div class="col-12">
                        <p><span class="title-field">Tên cơ quan: {{ $workPlace->nameAgency }}</span> <span
                                class="text-capitalize"></span></p>
                    </div>
                    <div class="clearb"></div>
                    <div class="col-6">
                        <p><span class="title-field">Điện thoại:
                                {{ $workPlace->phoneNumber }}</span> <span class="text-capitalize"></span></p>
                    </div>
                    <div class="col-6">
                        <p><span class="title-field">Fax:
                                {{ $workPlace->fax }}</span> <span class="text-capitalize"></span></p>
                    </div>
                    <div class="clearb"></div>
                    <div class="col-12">
                        <p><span class="title-field text-capitalize">Địa chỉ:
                                {{ $workPlace->address }}</span> <span class="text-capitalize"></span></p>
                    </div>
                    <div class="clearb"></div>
                    <div class="col-12">
                        <p><span class="title-field">Website:
                                {{ $workPlace->website }}</span> <span class="text-capitalize"></span></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold">10. Quá trình đào tạo:</span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold">12. Quá trình công tác:</span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
                    <table class="table-custom">
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold">13. Các lĩnh vực chuyên môn và hướng nghiên cứu:</span></p>
                </div>
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold">14. Hoạt động khoa học và công nghệ và giảng dạy</span></p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 pt-2">
                    <p class="p-width-all"><span class="title-field-bold pl-3">14.1. Đề tài nghiên cứu khoa học đã chủ trì hoặc là thành
                            viên:</span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p class="p-width-all"><span class="title-field-bold pl-3">14.2. Hướng dẫn sinh viên, học viên cao học,
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold pl-3">14.3.Giáo trình, tài liệu học tập đã chủ
                            biênhoặc tham gia:</span>
                    </p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold pl-3">14.4.Các bài báo đã công bố:</span>
                    </p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
                    <p><span class="title-field-bold pl-3">14.4.1. Đăng trên tạp chí:</span>
                    <p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
                ...
                <div class="clearb"></div>
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold pl-3">14.4.2. Đăng trên kỷ yếu hội nghị, hội
                            thảo:</span>
                    </p>
                </div>
                <div class="clearb"></div>
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p class="p-witdh-all"><span class="title-field-bold pl-3">14.5. Hướng dẫn sinh viên (học viên cao
                            học, nghiên cứu sinh) nghiên cứu khoa học:</span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
                    <table class="table-custom">
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <p><span class="title-field-bold">17. Ứng dụng thực tiễn và thương mại hóa kết quả nghiên
                            cứu:</span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row mt-3 d-block">
                <div class="col-12 mt-3">
                    <p class="p-witdh-all"><span class="title-field-bold">18. Giải thưởng về KH&CN, về chất lượng sản
                            phẩm,...:<span></p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row mt-3">
                {{-- <div class="clearb"></div> --}}
                <div class="col-12 mt-3">
                    <p class="p-witdh-all"><span class="title-field-bold">20. Tham gia các Hiệp hội khoa học, Ban biên
                            tập các Tạp chí khoa học, Ban tổ chức các Hội nghị về khoa học và công nghệ, các hội thảo/
                            hội nghị trong nước và quốc tế</span>
                    </p>
                </div>
                <div class="clearb"></div>
                <div class="col-12">
            ...
            <div class="row pt-3">
                <div class="col-12">
                    <p class="p-witdh-all"><span class="title-field-bold">21. Tham gia làm việc tại các trường Đại
            ...
            <div class="row pt-3">
                <div class="col-12">
                    <p><span class="title-field-bold">22. Kinh nghiệm về quản lý, đánh giá KH&CN</span></p>
                </div>
                <div class="clearb"></div>
            ...
            <div class="clearb"></div>
            <div class="row mt-5 pb-20" style="display: inline-block;">
                <div class="col-6 text-center mt-4">
                    <p class="title-field-bold m-0">Xác nhận của cơ quan quản lý</p>
                    <p class="p-width-all m-0"><i>(Ký tên, đóng dấu)</i></p>
                </div>
                <div class="col-6 text-center">
