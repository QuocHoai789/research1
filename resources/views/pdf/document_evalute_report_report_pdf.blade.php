    ...
    <div id="page-download">
        ...
        <div class="row">
            <div class="col-12 pl-3 text-center">
                <p class="text-uppercase font-weight-bold title-page ml-5">BIÊN BẢN HỌP HỘI ĐỒNG <br/>ĐÁNH GIÁ ĐỀ CƯƠNG CHI TIẾT TÀI LIỆU GIẢNG DẠY
                </p>
            </div>
        </div>
        <div class="page-content font-110">
            ...
            <div class="row">
                <div class="col-12 ml-3">
                    <p>
                        ...
                        <span class="font-weight-bold">
                            @isset($doc->registerdoc->objects_of_use)
            ...
            <div class="row p-t-10">
                <div class="col-12 ml-3">
                    <p class="p-l-15">
                        <span class="font-weight-bold"> Xếp loại: </span><span class="font-weight-bold">Tốt: </span> 80
                        điểm đến 100 điểm,
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="p-l-15 ml-3">1. Kết quả đánh giá và bỏ phiếu của Hội đồng</p>
                    <p class="p-l-25 ml-3"> Hội đồng tiến hành bỏ phiếu, kết quả kiểm phiếu
                        như sau</p>
                </div>
                <div class="clearb"></div>
                <div class="col-6 ml-3">
                ...
                <div class="col-12">
                    ...
                    <p class="p-l-15 ml-3">Trung bình điểm số: <span class="font-weight-bold">
                        @isset($avg_score)
                        {{ $avg_score }}
                        
                    </span> </p>
                    <p class="ml-3">2. Kết luận của Chủ tịch Hội đồng:</p>
                    <p class="p-l-15 ml-3"><span>a. Về kết quả bỏ phiếu:</span>
                        <span class="font-weight-bold">
                    ...
                    <p class="p-l-15 ml-3">b. Ý kiến của Hội đồng về những nội dung cần sửa
