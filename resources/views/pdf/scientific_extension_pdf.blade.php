...
<body>
    <div id="page-download">
        ...
        <div class="row ">
            <div class="col-12 text-center ml-3 mt-4 mb-4">
                <p class="text-uppercase font-weight-bold"><span style="font-size:18px">ĐỀ NGHỊ</span><br>
                    <span class="ml-3"  style="font-size:13px">Về việc xin gia hạn thực hiện đề tài nghiên cứu khoa học cấp Trường<br>
                    năm học 20… - 20…</span>
                </p>
        ...
        <div class="page-content font-110">
            <div class="row">
                <div class="col-2">
                    <p><span class="font-weight-bold title-field-bold tils"> Kính gửi:</span></p>
                </div>
                ...
                <div class="col-12">
                    <p>
                        ...
                        @isset($extension->expense_diff)
                            <span>
                                @isset($extension->expense_diff)
                                {{ number_format($extension->expense_diff) }}
                                @endisset
                                 đồng</span>
                        @endisset
                    </p>
